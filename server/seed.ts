...
**Outros exames:** [escore de cálcio coronário](/blog/escore-de-calcio-o-que-e-valores-e-o-que-fazer-com-o-resultado), Holter 24h, mapa de pressão arterial — conforme a indicação clínica.
...
- **[Escore de cálcio coronário (CAC)](/blog/escore-de-calcio-o-que-e-valores-e-o-que-fazer-com-o-resultado):** um dos melhores preditores de risco cardiovascular disponíveis
...
O [escore de cálcio coronário (CAC)](/blog/escore-de-calcio-o-que-e-valores-e-o-que-fazer-com-o-resultado) é o exame mais indicado para detectar aterosclerose subclínica em pessoas sem sintomas. A angiotomografia coronária fornece informação mais detalhada, incluindo placas não calcificadas. A indicação do exame depende do perfil de risco de cada paciente.
...
Se você tem diagnóstico de aterosclerose, histórico familiar de infarto precoce ou fatores de risco cardiovascular importantes, a avaliação com um cardiologista é o primeiro passo para definir seu risco e individualizar o tratamento. O consultório do Dr. Bruno Mioto, **cardiologista em São Paulo**, oferece avaliação especializada em doença coronariana e prevenção cardiovascular.`,
  ...
  {
    id: 17,
    title: "Escore de cálcio: o que é, valores e o que fazer com o resultado",
    slug: "escore-de-calcio-o-que-e-valores-e-o-que-fazer-com-o-resultado",
    excerpt: "O escore de cálcio mostra aterosclerose anos antes do primeiro sintoma. Entenda a tabela de valores, o que significa escore zero e o que muda no tratamento quando o resultado vem alto.",
    categoryId: 2,
    coverImage: "/escore-calcio-cover.webp",
    content: `## O que é o escore de cálcio coronário?

O **escore de cálcio coronário**, também chamado de **escore de Agatston** ou CAC (sigla em inglês para cálcio da artéria coronária), é um exame de tomografia computadorizada que mede a quantidade de cálcio depositada nas paredes das artérias do coração.

A lógica por trás dele é direta: cálcio nas coronárias só aparece onde existe [placa de aterosclerose](/blog/placa-de-aterosclerose-o-que-e-como-se-forma-e-se-pode-regredir). Artéria saudável não calcifica. Por isso o exame não estima um risco teórico, ele mostra doença que já começou, muitos anos antes de qualquer sintoma.

É um dos poucos exames capazes de transformar estatística em informação sobre o seu corpo. Duas pessoas com a mesma idade, o mesmo colesterol e a mesma pressão podem ter escores completamente diferentes, e é isso que muda a conduta.

## Tabela de valores: como interpretar o resultado

O resultado sai como um número único, somando o cálcio das três artérias principais.

| Escore | O que significa |
|---|---|
| 0 | Nenhum cálcio detectável. Risco muito baixo nos próximos anos |
| 1 a 99 | Aterosclerose leve. Decisão individualizada, com peso maior acima dos 55 anos |
| 100 a 399 | Aterosclerose moderada. Indicação de tratamento e controle intensivo dos fatores de risco |
| 400 a 999 | Doença extensa. Alto risco de eventos |
| 1.000 ou mais | Risco muito alto, com taxas de eventos comparáveis às de quem já infartou |

**Preste atenção no limite de 300.** A Diretriz Brasileira de Dislipidemias e Prevenção da Aterosclerose 2025, da Sociedade Brasileira de Cardiologia, classifica escore acima de 300 como **risco muito alto**, a mesma categoria de quem já teve um evento, com meta de LDL abaixo de 50 mg/dL. Em quem tem diabetes o limite é bem menor: escore entre 10 e 300 já classifica como alto risco.

**O percentil importa tanto quanto o número.** Um escore de 80 aos 70 anos é comum. O mesmo 80 aos 45 anos coloca a pessoa entre as piores da faixa etária e muda completamente a decisão. Peça sempre o percentil para idade e sexo junto do valor absoluto.

## Escore zero: o que ele garante, e por quanto tempo

Escore zero é o melhor resultado possível e o mais mal interpretado.

Ele significa risco muito baixo de infarto no curto e médio prazo, e é a principal situação em que se pode adiar com segurança o início de uma estatina em alguém que estava na dúvida. Mas zero não é um passaporte vitalício.

O estudo MESA, que acompanhou milhares de pessoas com escore zero, mostrou que a validade prática desse resultado fica entre **3 e 7 anos**, dependendo da idade e dos fatores de risco de cada um. Cerca de 25% das pessoas já tinham cálcio detectável em seis anos, e metade em dez anos. Em quem tem diabetes, esse prazo encurta bastante.

Há uma segunda limitação, mais importante: o exame enxerga cálcio, não placa. **Placa jovem, mole e não calcificada não aparece.** É por isso que um escore zero é muito menos tranquilizador em uma pessoa de 40 anos, fumante, ou com [Lp(a) elevada](/blog/lpa-lipoproteina-a-o-que-e-valor-normal-e-risco-cardiovascular) e história familiar de infarto precoce. Nesses casos o zero não encerra a conversa.

## Meu escore deu alto. E agora?

Primeiro, a parte que ninguém diz em voz alta: escore alto não é sentença de infarto e não significa que você precisa de cateterismo. Ele não mede entupimento, mede quantidade de doença.

O que muda, na prática:

- **A meta de colesterol fica mais rigorosa.** Sair de um LDL abaixo de 100 para abaixo de 70 ou de 50 costuma significar começar ou intensificar a estatina
- **Pressão, glicemia e tabagismo passam a ser tratados com outro nível de exigência**
- **A adesão melhora.** Ver o próprio cálcio é, na prática clínica, um dos argumentos mais convincentes que existem para alguém levar a prevenção a sério
- **Não se repete o exame para acompanhar tratamento.** O cálcio pode até aumentar com estatina, porque a placa se estabiliza calcificando. Repetir o escore para ver "se melhorou" gera confusão sem informação útil

Se houver sintomas, como dor no peito ou falta de ar aos esforços, o caminho é outro: o escore de cálcio não é o exame indicado para investigar sintoma.

## Quem deve fazer o exame

A diretriz brasileira de 2025 recomenda primeiro calcular o risco pela calculadora **PREVENT**, para pessoas de 30 a 79 anos sem doença cardiovascular conhecida. O escore de cálcio entra depois, como desempate:

- **Recomendação forte** para quem ficou em **risco intermediário**, tem mais de 40 anos e LDL entre 70 e 159 mg/dL. É aqui que o exame rende mais, porque é exatamente a faixa em que médico e paciente ficam na dúvida sobre começar ou não o remédio
- **Recomendação condicional** para quem ficou em **risco baixo**, tem mais de 40 anos e história familiar de doença cardiovascular precoce

Ou seja, o exame serve para decidir, não para rastrear todo mundo.

## Quem não precisa fazer

- Quem **já teve infarto, AVC ou colocou stent**. O risco já está definido e o tratamento é máximo de qualquer forma
- Quem **já é de risco muito alto** por outros critérios, porque o resultado não mudaria a conduta
- Quem **tem sintomas cardíacos**, que exige teste funcional ou angiotomografia
- Quem tem **menos de 40 anos** e nenhum fator de risco relevante

## Como é feito o exame

É uma tomografia rápida e simples. **Não usa contraste** e **não exige jejum**. A pessoa deita, são colocados eletrodos no tórax para sincronizar as imagens com o batimento, e pede-se que prenda a respiração por alguns segundos. A aquisição leva poucos minutos e a visita inteira costuma ficar em 15 a 20 minutos.

A dose de radiação é baixa, em torno de 1 mSv na maioria dos protocolos modernos, menos do que a radiação natural que qualquer pessoa recebe ao longo de um ano. É necessário pedido médico.

## FAQ: perguntas frequentes sobre o escore de cálcio

**Escore de cálcio zero significa que estou livre de infarto?** Não. Significa risco muito baixo por um período que costuma ser de 3 a 7 anos. Placa não calcificada não aparece no exame, então o zero é menos tranquilizador em jovens, fumantes e diabéticos.

**Escore de cálcio alto significa artéria entupida?** Não. O exame mede quantidade de doença, não grau de obstrução. É possível ter escore alto com artérias sem estreitamento importante.

**Dá para baixar o escore de cálcio?** Não, e não é esse o objetivo. O cálcio tende a aumentar mesmo com tratamento correto, porque estabilizar a placa envolve calcificá-la. O que se trata é o risco, não o número.

**Preciso repetir o exame?** Para acompanhar tratamento, não. Para reavaliar quem deu zero e segue sem tratamento, costuma fazer sentido depois de alguns anos, conforme o perfil de risco.

**O plano de saúde cobre?** A cobertura varia conforme a indicação e o plano. Vale confirmar com a operadora antes, com o pedido médico em mãos.

**Qual a diferença entre escore de cálcio e angiotomografia de coronárias?** O escore mede cálcio, sem contraste, e serve para estratificar risco em quem não tem sintomas. A angiotomografia usa contraste, mostra o interior das artérias e serve para investigar sintomas ou doença obstrutiva.

**Com que idade devo fazer?** Em geral a partir dos 40 anos, e apenas quando o resultado for mudar a decisão de tratar. Antes disso, só em situações específicas, como história familiar de infarto precoce.

Como **cardiologista em São Paulo** com foco em prevenção cardiovascular, uso o escore de cálcio principalmente naquele paciente que está no meio do caminho, em que a decisão de iniciar tratamento não é óbvia. Se você fez o exame e ficou com o resultado na mão sem saber o que ele significa, ou quer entender se faz sentido no seu caso, vale marcar uma [avaliação de risco cardiovascular](/blog/check-up-cardiologico-quando-fazer-e-o-que-esperar).
