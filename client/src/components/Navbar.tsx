      ...
      <div className="container">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="/kairosmentoria"
              className="text-sm tracking-wide transition-opacity hover:opacity-70 cursor-pointer"
              style={{
                color: "#B8955F",
                fontFamily: "'Inter', sans-serif",
                letterSpacing: "0.05em",
      ...
      {isOpen && (
        ...
        >
          <div className="container py-4 flex flex-col gap-4">
            ...
            <a
              href="/kairosmentoria"
              className="text-left text-sm py-2 tracking-wide transition-opacity hover:opacity-70"
              style={{ color: "#B8955F", fontFamily: "'Inter', sans-serif", fontWeight: 600 }}
            >
              Mentoria Kairós
            </a>
            <button
